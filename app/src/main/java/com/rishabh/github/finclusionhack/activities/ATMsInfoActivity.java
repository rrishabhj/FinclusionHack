...
public class ATMsInfoActivity extends BaseActivity implements LocationsListAdapter.LocationsListListener {
        ...
        (new AsyncTask<Void, Void, LocationsList>() {
            ...
            protected LocationsList doInBackground(Void... params) {
                try {
                    ...
                    queryParams.add(new BasicNameValuePair("type", "ATM"));
                    ...
                    Log.e(ATMsInfoActivity.this.getClass().toString(), e.getLocalizedMessage());
                }
                return null;
            }
    ...
    public void onLocationSelected(LocationInfo locationInfo) {
        Log.e(ATMsInfoActivity.this.getClass().toString(), locationInfo.LocationName);
